...
class ZigmarsBot(discord.Client):
    ...
    @staticmethod
    def load_logged_messages() -> list[str]:
    ...
    def log_message(self, message: discord.Message) -> None:
        ...
        try:
            ...
            self.logged_messages.append(content)
        except OSError:
    ...
    async def on_message(self, message: discord.Message) -> None:
        ...
        if trigger_fired:
            ...
            if elapsed < COOLDOWN_SECONDS:
                ...
                # Simple replay algorithm: choose one previously logged message.
                reply = random.choice(self.logged_messages)
